...
export const FR: Record<string, LegalDoc> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        heading: 'La connexion avec Google ou Apple',
        body: "Si tu te connectes avec Google, Google nous transmet ton nom, ton adresse e-mail, ta photo de profil et l'identifiant de ton compte Google. Si tu te connectes avec Apple, Apple nous transmet ton nom et une adresse e-mail, qui est une adresse relais privée si tu as choisi de masquer la tienne. Nous ne nous en servons que pour créer ton compte, te reconnecter et te contacter à son sujet — jamais pour autre chose. Ces données sont conservées dans notre base d'authentification chez Supabase, dans l'UE, tant que ton compte existe, et elles sont supprimées avec lui. Nous ne les vendons pas, nous ne les cédons pas à des courtiers en données, nous ne les utilisons ni pour la publicité ni pour le ciblage publicitaire, et nous ne les utilisons pas pour entraîner des modèles généraux d'intelligence artificielle ou d'apprentissage automatique. Nous ne recevons jamais ton mot de passe Google ou Apple, et nous ne te le demandons jamais.",
      },
      {
