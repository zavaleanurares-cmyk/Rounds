...
export const RO: Record<string, LegalDoc> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        heading: 'Conectarea cu Google sau Apple',
        body: 'Dacă te conectezi cu Google, Google ne trimite numele tău, adresa ta de e-mail, poza ta de profil și identificatorul contului tău Google. Dacă te conectezi cu Apple, Apple ne trimite numele tău și o adresă de e-mail, care este o adresă-releu privată dacă ai ales să o ascunzi pe a ta. Le folosim doar ca să îți creăm contul, ca să te reconectăm și ca să te contactăm despre contul tău — pentru nimic altceva. Sunt păstrate în baza noastră de autentificare la Supabase, în UE, cât timp există contul tău, și se șterg odată cu el. Nu le vindem, nu le dăm brokerilor de date, nu le folosim pentru publicitate sau pentru targetare publicitară și nu le folosim pentru a antrena modele generale de inteligență artificială sau de învățare automată. Nu primim niciodată parola ta de Google sau de Apple și nu ți-o cerem niciodată.',
      },
      {
