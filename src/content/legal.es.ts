...
export const ES: Record<string, LegalDoc> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        heading: 'Iniciar sesión con Google o Apple',
        body: 'Si inicias sesión con Google, Google nos envía tu nombre, tu dirección de correo electrónico, tu foto de perfil y el identificador de tu cuenta de Google. Si inicias sesión con Apple, Apple nos envía tu nombre y una dirección de correo, que es una dirección de reenvío privada si elegiste ocultar la tuya. Solo los usamos para crear tu cuenta, volver a iniciar tu sesión y contactarte sobre ella — nunca para nada más. Se conservan en nuestra base de autenticación en Supabase, en la UE, mientras exista tu cuenta, y se eliminan junto con ella. No los vendemos, no los cedemos a intermediarios de datos, no los usamos para publicidad ni para segmentación publicitaria, y no los usamos para entrenar modelos generales de inteligencia artificial o de aprendizaje automático. Nunca recibimos tu contraseña de Google o de Apple, y nunca te la pedimos.',
      },
      {
