...
export const discover = {
  ...
  'discover.addPlaceNote': 'Only you can see the places you add.',
  'discover.whosBeenNobody': "Nobody yet.",
  'discover.whosBeenUnknown': "Can't check right now.",
  'discover.venueCategory': 'What kind of place',
  'discover.kindBar': 'Bar',
  'discover.kindClub': 'Club',
  'discover.kindWine': 'Wine bar',
  'discover.kindRestaurant': 'Restaurant',
  'discover.kindCafe': 'Café',
  'discover.useMyLocation': 'Use my location',
  'discover.locationCaptured': 'Pinned where you are',
  'discover.locationUnavailable': 'No location — it will still be saved, just not on the map',
