...
export const common = {
  ...
  'common.achNewPlaceHint': 'Ve a un sitio en el que no hayas estado nunca.',
  ...
  'common.you': 'Tú',
  'common.categoryNicotine': 'Nicotina',
  'common.mapCluster': { one: '{count} sitio aquí', other: '{count} sitios aquí' },
